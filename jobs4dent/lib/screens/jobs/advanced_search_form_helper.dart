...
class AdvancedSearchFormHelper {
  ...
  void saveStateAndSearch(JobProvider jobProvider, String? userId) {
    ...
    jobProvider.searchJobsWithAI(
      ...
      minSalary: minSalaryController.text.trim().isEmpty ? null : double.tryParse(minSalaryController.text.trim()),
      maxSalary: maxSalaryController.text.trim().isEmpty ? null : double.tryParse(maxSalaryController.text.trim()),
      startDate: startDate,
      endDate: endDate,
