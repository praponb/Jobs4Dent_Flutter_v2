...
class MyPostedAssistantJobsScreen extends StatefulWidget {
  ...
  @override
  State<MyPostedAssistantJobsScreen> createState() => _MyPostedAssistantJobsScreenState();
}

class _MyPostedAssistantJobsScreenState extends State<MyPostedAssistantJobsScreen> 
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: job.workType == 'Full-time' ? Colors.green[50] : Colors.orange[50],
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        fontSize: 12,
                        color: job.workType == 'Full-time' ? Colors.green[700] : Colors.orange[700],
                    ...
                    child: OutlinedButton.icon(
                      onPressed: () {
                        Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => AssistantJobPostingScreen(jobToEdit: job),
                          ),
                        ).then((_) => _loadJobs());
                      },
                    ...
                    child: ElevatedButton.icon(
                      onPressed: job.applicationCount > 0 ? () {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(
                            content: Text('ฟีเจอร์การจัดการผู้สมัครงานผู้ช่วยทันตแพทย์จะพัฒนาเพิ่มในอนาคต'),
                          ),
                        );
                      } : null,
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          _buildDetailSection('รายละเอียดงาน', [
                            ...
                            _buildDetailRow('จำนวนทักษะที่ต้องการ', '${job.skillAssistant.length} ทักษะ'),
                          ]),
                          ...
                          _buildDetailSection('สถิติ', [
                            _buildDetailRow('จำนวนผู้สมัคร', '${job.applicationCount} คน'),
