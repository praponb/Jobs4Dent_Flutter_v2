...
class AuthErrorHandler {
  ...
  static const String registrationSuccess = 'ลงทะเบียนสำเร็จแล้ว! กรุณาตรวจสอบอีเมลเพื่อยืนยันบัญชีของคุณ';
  static const String emailVerificationSent = 'ส่งอีเมลยืนยันแล้ว! กรุณาตรวจสอบกล่องจดหมายของคุณ';
  static const String passwordResetSent = 'ส่งอีเมลรีเซ็ตรหัสผ่านแล้ว! กรุณาตรวจสอบกล่องจดหมายของคุณ';
  static const String subUserCreated = 'สร้างผู้ใช้ย่อยสำเร็จแล้ว! อีเมลยืนยันถูกส่งไปแล้ว';
  ...
  static const String clinicOwnerOnly = 'Only clinic owners can create sub-users';
} 